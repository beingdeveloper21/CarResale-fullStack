    ...
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 mt-48 text-sm text-gray-500">
      ...
      >
        <div className="max-w-sm">
          <motion.h3 {...fadeUp(0.2)} className="text-xl font-bold text-gray-900 mb-3">
            Car Resale Marketplace
          </motion.h3>

          <motion.p {...fadeUp(0.3)} className="leading-relaxed text-gray-600">
            Used car resale marketplace with verified listings, clear specs,
            and direct buyer enquiries.
          </motion.p>
        ...
        >
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-2">
              {["Home", "Browse Cars", "Sell Your Car", "About Us"].map(
                (item) => (
                  <li key={item}>
          ...
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-2">
              {["Help Center", "Terms of Service", "Privacy Policy", "Inspection Guide"].map(
                (item) => (
                  <li key={item}>
                    <a className="hover:text-gray-700 transition" href="#">
                      {item}
      ...
      >
        <p>(c) {new Date().getFullYear()} Car Resale. All rights reserved.</p>
